    ...
    <el-card>
      ...
      <el-table :data="tableData" v-loading="loading" border stripe>
        ...
        <el-table-column prop="sample_type" label="类型" width="100">
          <template #default="{ row }">
            <el-tag :type="sampleTypeTag(row.sample_type)" size="small">
              {{ sampleTypeLabel(row.sample_type) }}
            </el-tag>
          </template>
        </el-table-column>
...
import SampleAPI from "@/api/aitc/sample";
import type { OptionItem, PageResult } from "@/api/common";
import type { SampleItem, SampleForm, SampleQueryParams } from "@/api/aitc/sample";
import { sampleTypeTag, sampleTypeLabel } from "../constants";
