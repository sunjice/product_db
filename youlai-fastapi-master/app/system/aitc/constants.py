...
PERM_AICONFIG_LIST   = "aitc:aiconfig:list"
PERM_AICONFIG_CREATE = "aitc:aiconfig:create"
PERM_AICONFIG_UPDATE = "aitc:aiconfig:update"
PERM_AICONFIG_DELETE = "aitc:aiconfig:delete"
